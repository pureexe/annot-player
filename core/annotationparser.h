#ifndef _CORE_ANNOTATIONPARSER_H
#define _CORE_ANNOTATIONPARSER_H

// core/annotationparser.h
// 8/19/2011
...
namespace Core {
  ...
  {
    typedef AnnotationParser Self;

    QString tinySize_, smallSize_, normalSize_, largeSize_, hugeSize_;

    //static Self *global_;
  public:
    static Self *globalInstance(); // Initial value is the default parser, not NULL.
  ...
  public:
    ...
    std::pair<QString, QStringList> renderToHtml(const QString &annot) const;
...
#endif // _CORE_ANNOTATIONPARSER_H
