       ...
       me_annot_service::Chat::Chat(std::string arg_Arg0)
        {
        ...
        bool WSF_CALL
        me_annot_service::Chat::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
          ...
          bool WSF_CALL
          me_annot_service::Chat::isParticle()
          {
          ...
          void WSF_CALL
          me_annot_service::Chat::declareParentNamespaces(
	...
	me_annot_service::Chat::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = (axis2_char_t*)property_Arg0.c_str();
             ...
             */
            std::string WSF_CALL
            me_annot_service::Chat::getProperty1()
            {
                return getArg0();
            }
             ...
             */
            bool WSF_CALL
            me_annot_service::Chat::setArg0(
                    const std::string  arg_Arg0)
             {
                ...
                resetArg0();
                        ...
                        property_Arg0 = std::string(arg_Arg0.c_str());
                        isValidArg0 = true;
            ...
            */
           bool WSF_CALL
           me_annot_service::Chat::resetArg0()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           me_annot_service::Chat::isArg0Nil()
           {
               return !isValidArg0;
           }
            ...
            */
           bool WSF_CALL
           me_annot_service::Chat::setArg0Nil()
           {
               return resetArg0();
           }
