        ...
        using namespace me_annot_service;
                 ...
                 */
           me_annot_service::Deauthorize::Deauthorize()
        {
       ...
       me_annot_service::Deauthorize::~Deauthorize()
        ...
        bool WSF_CALL
        me_annot_service::Deauthorize::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
          ...
          bool WSF_CALL
          me_annot_service::Deauthorize::isParticle()
          {
          ...
          void WSF_CALL
          me_annot_service::Deauthorize::declareParentNamespaces(
	...
	me_annot_service::Deauthorize::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
