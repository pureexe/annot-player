        ...
        using namespace me_annot_service;
                 ...
                 */
           me_annot_service::IsAuthorized::IsAuthorized()
        {
       ...
       me_annot_service::IsAuthorized::~IsAuthorized()
        ...
        bool WSF_CALL
        me_annot_service::IsAuthorized::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
          ...
          bool WSF_CALL
          me_annot_service::IsAuthorized::isParticle()
          {
          ...
          void WSF_CALL
          me_annot_service::IsAuthorized::declareParentNamespaces(
	...
	me_annot_service::IsAuthorized::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
