...
//#ifdef DEBUG
//  #define DOUT(_msg)    qDebug() << "Player:" << _msg
//#else
//  #define DOUT(_dummy)
//
//  #ifdef _MSC_VER
...
#define VLC_PLUGIN_PATH         (QApplication::applicationDirPath() + "/plugins").toAscii()
...
#define VLC_ARGS_RELEASE        VLC_ARGS_CONFIG, VLC_ARGS_INTERFACE, VLC_ARGS_PLUGIN_PATH, VLC_ARGS_OS
#define VLC_ARGS_DEBUG          VLC_ARGS_RELEASE, VLC_ARGS_LOG, VLC_ARGS_VERBOSE(2)
