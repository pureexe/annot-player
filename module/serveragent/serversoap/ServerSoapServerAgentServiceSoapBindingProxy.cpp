...
void ServerAgentServiceSoapBindingProxy::reset()
{	destroy();
	soap_done(this);
	soap_init(this);
	ServerAgentServiceSoapBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://210.175.54.32/services/ServerAgentPort";
	if (!soap_action)
		soap_action = "";
...
int ServerAgentServiceSoapBindingProxy::blessUserWithId(const char *endpoint, const char *soap_action, tns__blessUserWithId *tns__blessUserWithId_, tns__blessUserWithIdResponse *tns__blessUserWithIdResponse_)
{	struct soap *soap = this;
...
int ServerAgentServiceSoapBindingProxy::curseUserWithId(const char *endpoint, const char *soap_action, tns__curseUserWithId *tns__curseUserWithId_, tns__curseUserWithIdResponse *tns__curseUserWithIdResponse_)
{	struct soap *soap = this;
...
int ServerAgentServiceSoapBindingProxy::selectRelatedMediaAliasesWithTokenId(const char *endpoint, const char *soap_action, tns__selectRelatedMediaAliasesWithTokenId *tns__selectRelatedMediaAliasesWithTokenId_, tns__selectRelatedMediaAliasesWithTokenIdResponse *tns__selectRelatedMediaAliasesWithTokenIdResponse_)
{	struct soap *soap = this;
...
int ServerAgentServiceSoapBindingProxy::updateMediaAnnotationUserIdWithId(const char *endpoint, const char *soap_action, tns__updateMediaAnnotationUserIdWithId *tns__updateMediaAnnotationUserIdWithId_, tns__updateMediaAnnotationUserIdWithIdResponse *tns__updateMediaAnnotationUserIdWithIdResponse_)
{	struct soap *soap = this;
