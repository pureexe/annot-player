// imagefilter/filters.cc
// 6/14/2012
#include "lib/imagefilter/filters.h"
#include "lib/imagefilter/qtfilters.h"
...
void
blurImage(QPainter *p, QImage &blurImage, qreal radius, bool quality, bool alphaOnly, int transposed)
{
