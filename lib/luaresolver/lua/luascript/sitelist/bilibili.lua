...
function getTaskAttribute_bilibili ( str_url, str_tmpfile, pDlg, isNeedLogin, bSubOnly)
  ...
  -- jichi 6/8/2012: skip parsing pageno and vice_descriptor
--
...
--dbgMessage(str_embed);
  ...
  if string.find(str_id, "levelup", 1, true)~=nil then
    ...
    str_notsinaurl = "http://pl.bilibili.com/"..string.gsub(str_id, "levelup", "/")..".flv";
  end
...
--dbgMessage(str_id);
  ...
  --str_subxmlurl = "http://www.bilibili.com/dm," .. str_id .. "?r=126";
  --str_subxmlurl = "http://comment.bilibili.com/dm," .. str_id;
  str_subxmlurl = "http://comment.bilibili.com/" .. str_id .. ".xml";
...
function getTaskAttributeBatch_bilibili ( str_url, str_tmpfile , pDlg)
  ...
  urlprefix = "http://www.bilibili.com/video/av"..str_biliid.."/"
