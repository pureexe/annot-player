...
#else
# error "require lib textcodec"
#endif // WITH_LIB_TEXTCODEC
...
enum { CT_Verb = 2, CT_Noun = 8, CT_Modifier = 6, CT_Punct = 3, CT_Katagana = 7, CT_Latin = 4, CT_Latin2 = 5, CT_Greek = 9 };
