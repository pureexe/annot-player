        ...
        using namespace me_annot_service;
                 ...
                 */
           me_annot_service::ChatResponse::ChatResponse()
        {
       ...
       me_annot_service::ChatResponse::~ChatResponse()
        ...
        bool WSF_CALL
        me_annot_service::ChatResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
          ...
          bool WSF_CALL
          me_annot_service::ChatResponse::isParticle()
          {
          ...
          void WSF_CALL
          me_annot_service::ChatResponse::declareParentNamespaces(
	...
	me_annot_service::ChatResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
