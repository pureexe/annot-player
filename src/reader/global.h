...
#ifdef Q_OS_WIN
# define G_PATH_PROFILE        QtWin::getAppDataPath() + "/" "me.annot.reader"
#elif defined(Q_OS_MAC)
# define G_PATH_PROFILE        QtMac::homeApplicationSupportPath() + "/me.annot.reader"
#else
# define G_PATH_PROFILE        QDir::homePath() + "/.annot/reader"
#endif // Q_OS_
...
# define G_PATH_DEBUG  G_PATH_LOGS "/" "Debug Reader.txt"
#elif defined(Q_OS_MAC)
...
#elif defined(Q_OS_MAC)
# define G_PATH_CACHES QtMac::homeCachesPath() + "/me.annot.reader"
#else
