...
#define SS_TOOLBUTTON_LIBRARY   SS_TOOLBUTTON_(LIBRARY)

#define SS_TOOLBUTTON_UPARROW   SS_TOOLBUTTON_(UPARROW)
#define SS_TOOLBUTTON_DOWNARROW SS_TOOLBUTTON_(DOWNARROW)
