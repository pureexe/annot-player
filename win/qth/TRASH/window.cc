...
//#define DEBUG
#ifdef DEBUG
  #define DOUT(_msg)    qDebug() << "ith:window:" << _msg
#else
  #define DOUT(_dummy)
#endif // DEBUG
...
HWND hMainWnd,hwndCombo,hwndProc,hwndEdit;
HWND hwndHook;
...
DWORD cyclic_remove,repeat_count,global_filter;
...
static EditFun EditFunTable[]={EditLinkDlgProc,EditCommentDlgProc};
