...
%description
Annot Translator is a software for Japanese Translation.
...
%build
qmake-qt4 -config release PREFIX=/usr project/translator/translator.pro
make %{?_smp_mflags}
