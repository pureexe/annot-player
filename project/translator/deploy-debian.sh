...
SRC_RULES="$SRC_PREFIX/project/translator/debian.rules"
SRC_CONTROL="$SRC_PREFIX/project/translator/debian.control"
SRC_COPYRIGHT="$SRC_PREFIX/licenses/annot-dict.txt"
SRC_CHANGELOG="$SRC_PREFIX/ChangeLog"
BUILD_PREFIX=$HOME/build/annot-dict
