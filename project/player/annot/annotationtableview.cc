...
AnnotationTableView::AnnotationTableView(SignalHub *hub, QWidget *parent)
    ...
    userId_(0), annotationPos_(0), editor_(0), contextMenu_(0)
{
  ...
  // Initial states
  tableView_->sortByColumn(AnnotationStandardModel::HD_CreateTime, Qt::DescendingOrder);
  tableView_->setCurrentColumn(AnnotationStandardModel::HD_Text);
}

void
AnnotationTableView::createModel()
{
  sourceModel_ = new AnnotationStandardModel(hub_, this);
  ...
  filterMeModel_ = new QSortFilterProxyModel; {
    ...
    filterMeModel_->setFilterKeyColumn(AnnotationStandardModel::HD_UserId);
  ...
  filterNowModel_ = new QSortFilterProxyModel; {
    ...
    filterNowModel_->setFilterKeyColumn(AnnotationStandardModel::HD_Pos);
  ...
  filterSubtitleModel_ = new QSortFilterProxyModel; {
    ...
    filterSubtitleModel_->setFilterKeyColumn(AnnotationStandardModel::HD_Text);
...
void
AnnotationTableView::createLayout()
{
...
void
AnnotationTableView::createContextMenu()
{
  // Create menus
...
AnnotationEditor*
AnnotationTableView::editor() const
{
  if (!editor_) {
...
QModelIndex
AnnotationTableView::currentIndex() const
{ return tableView_->currentIndex(); }

qint64
AnnotationTableView::currentId() const
{ return sourceModel_->indexId(currentIndex()); }

qint64
AnnotationTableView::currentUserId() const
{ return sourceModel_->indexUserId(currentIndex()); }

QString
AnnotationTableView::currentUserAlias() const
{ return sourceModel_->indexUserAlias(currentIndex()); }

QString
AnnotationTableView::currentText() const
{ return sourceModel_->indexText(currentIndex()); }

void
AnnotationTableView::setAnnotations(const AnnotationList &l)
{
  clear();
  addAnnotations(l);
}
...
bool
AnnotationTableView::isEmpty() const
{ return sourceModel_->isEmpty(); }

void
AnnotationTableView::addAnnotation(const Annotation &a)
{
...
void
AnnotationTableView::addAnnotations(const AnnotationList &l)
{
  if (!l.isEmpty()) {
...
void
AnnotationTableView::removeAnnotations()
{ tableView_->clear(); }

void
AnnotationTableView::clear()
{ removeAnnotations(); }

void
AnnotationTableView::removeAnnotationWithId(qint64 id)
{
...
void
AnnotationTableView::takeAnnotationOwnership()
{
  ...
  int row = index.row();
  QModelIndex mi = index.sibling(row, AnnotationStandardModel::HD_UserId);
...
void
AnnotationTableView::saveAnnotationText(const QString &text)
{
  ...
  QModelIndex mi = editedIndex_.sibling(row, AnnotationStandardModel::HD_Text);
...
void
AnnotationTableView::updateAnnotationTextWithId(const QString &text, qint64 id)
{ sourceModel_->updateAnnotationTextWithId(text, id); }

void
AnnotationTableView::updateAnnotationUserIdWithId(qint64 userId, qint64 id)
{ sourceModel_->updateAnnotationUserIdWithId(userId, id); }

void
AnnotationTableView::editAnnotation()
{
  // TODO: CHECKPOINT
  qint64 id = currentId();
  if (!id)
...
void
AnnotationTableView::copyAnnotation()
{
...
void
AnnotationTableView::deleteAnnotation()
{
  if (!userId_ || currentUserId() != userId_) {
...
void
AnnotationTableView::blessAnnotation()
{
  qint64 id = currentId();
  if (id)
...
void
AnnotationTableView::curseAnnotation()
{
  qint64 id = currentId();
  if (id)
...
void
AnnotationTableView::blockAnnotation()
{
  QString text = currentText();
  if (!text.isEmpty())
...
void
AnnotationTableView::viewUser()
{
  // CHECKPOINT
}

void
AnnotationTableView::blockUser()
{
...
void
AnnotationTableView::analyzeUser()
{
  qint64 uid = currentUserId();
  if (uid)
...
void
AnnotationTableView::setVisible(bool visible)
{
  if (visible) {
    invalidateFilters();
    tableView_->updateCount();
...
void
AnnotationTableView::contextMenuEvent(QContextMenuEvent *event)
{
...
void
AnnotationTableView::updateContextMenu()
{
  if (!contextMenu_)
    createContextMenu();
...
//void AnnotationTableView::dragEnterEvent(QDragEnterEvent *event)     { emit dragEnterEventReceived(event); }
//void AnnotationTableView::dragMoveEvent(QDragMoveEvent *event)       { emit dragMoveEventReceived(event); }
//void AnnotationTableView::dragLeaveEvent(QDragLeaveEvent *event)     { emit dragLeaveEventReceived(event); }
//void AnnotationTableView::dropEvent(QDropEvent *event)               { emit dropEventReceived(event); }

// - Filters -

void
AnnotationTableView::setAnnotationPos(qint64 pos)
{
  annotationPos_ = pos;
  if (isVisible())
    invalidateFilters();
...
void
AnnotationTableView::setNow(bool t)
{
  QString s;
  if (t) {
...
void
AnnotationTableView::setMe(bool t)
{
  QString s;
  if (t) {
...
void
AnnotationTableView::setSubtitle(bool t)
{
  QString s;
  if (t)
    s = CORE_CMD_SUB;
...
void
AnnotationTableView::invalidateFilters()
{
