#ifndef ANNOTATIONTABLEVIEW_H
#define ANNOTATIONTABLEVIEW_H
...
class AnnotationStandardModel;
class SignalHub;

class AnnotationTableView : public AcMainWindow
{
  Q_OBJECT
  Q_DISABLE_COPY(AnnotationTableView)
  typedef AnnotationTableView Self;
...
public:
  explicit AnnotationTableView(SignalHub *hub, QWidget *parent = nullptr);
...
private:
  ...
  AnnotationStandardModel *sourceModel_;
