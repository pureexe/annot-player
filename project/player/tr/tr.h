...
#define TR(_tid)        Translator::globalInstance()->translate(_tid)
...
#define T_PINK          0x308
#define T_RED           0x309
#define T_WHITE         0x30a
#define T_YELLOW        0x30b
...
#define T_TOOLTIP_COMMANDLINE    0x64
...
#define T_MENUTEXT_TRENDVIEW    0x103
#define T_TIP_TRENDVIEW         0x104
#define T_TOOLTIP_TRENDVIEW   T_TIP_TRENDVIEW
#define T_STATUSTIP_TRENDVIEW T_TIP_TRENDVIEW
