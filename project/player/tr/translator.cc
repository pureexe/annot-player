...
Translator::translate(int tid) const
{
  ...
  case T_TITLE_TRENDVIEW:       return tr("Trend");
  ...
  case T_MENUTEXT_SHOWANNOT:    return tr("&Annots");
  ...
  case T_MENUTEXT_TRENDVIEW:    return tr("Trend browser");
  case T_TIP_TRENDVIEW:         return tr("Show trend browser");
