...
#define RC_IMAGE_USER                   RC_NULL
#define RC_IMAGE_USER_BLANK             RC_NULL
#define RC_IMAGE_USER_HOVER             RC_NULL
#define RC_IMAGE_USER_PRESSED           RC_NULL
#define RC_IMAGE_USER_DISABLED          RC_NULL
#define RC_IMAGE_USER_CHECKED           RC_NULL
#define RC_IMAGE_USER_CHECKED_HOVER RC_IMAGE_USER_HOVER
#define RC_IMAGE_SNAPSHOT               RC_NULL
#define RC_IMAGE_SNAPSHOT_BLANK         RC_NULL
#define RC_IMAGE_SNAPSHOT_HOVER         RC_NULL
#define RC_IMAGE_SNAPSHOT_PRESSED       RC_NULL
#define RC_IMAGE_SNAPSHOT_DISABLED      RC_NULL
#define RC_IMAGE_SNAPSHOT_CHECKED       RC_NULL
...
// TODO
#define RC_IMAGE_SEEK           RC_NULL
#define RC_IMAGE_REPLAY         RC_NULL

#define RC_IMAGE_PREVIOUSSECTION RC_IMAGE_PREVIOUS
#define RC_IMAGE_NEXTSECTION     RC_IMAGE_NEXT

#define RC_IMAGE_ENABLEBLACKLIST      RC_NULL
#define RC_IMAGE_BLACKLIST      RC_NULL
#define RC_IMAGE_BACKLOG        RC_NULL
#define RC_IMAGE_DOWNLOAD       RC_NULL
#define RC_IMAGE_CONSOLE        RC_NULL
#define RC_IMAGE_SECTION        RC_NULL
#define RC_IMAGE_CURRENTSECTION RC_IMAGE_PLAY
#define RC_IMAGE_SUBTITLE       RC_NULL
#define RC_IMAGE_AUDIOTRACK     RC_NULL
#define RC_IMAGE_ANNOTSUBTITLE  RC_NULL
#define RC_IMAGE_SUBANNOT       RC_NULL
#define RC_IMAGE_NONSUBANNOT    RC_NULL
...
#define RC_IMAGE_SHOWMENUBAR    RC_NULL
#define RC_IMAGE_ENABLEAERO     RC_NULL
#define RC_IMAGE_DISABLEAERO    RC_NULL
#define RC_IMAGE_MENUTHEME      RC_NULL

#define RC_IMAGE_FORWARD        RC_NULL
#define RC_IMAGE_BACKWARD       RC_NULL
...
#define RC_IMAGE_LOGO   RC_NULL
#define RC_IMAGE_QUIT   RC_NULL
#define RC_IMAGE_ABOUT  RC_NULL
#define RC_IMAGE_HELP   RC_NULL
#define RC_IMAGE_UPDATE RC_NULL

#define RC_IMAGE_LOGIN  RC_NULL
#define RC_IMAGE_LOGOUT RC_NULL

#define RC_IMAGE_COPY   RC_NULL
#define RC_IMAGE_PASTE  RC_NULL

#define RC_IMAGE_ENABLEAUTOCLEARCONSOLE         RC_NULL
#define RC_IMAGE_DISABLEAUTOCLEARCONSOLE        RC_NULL

#define RC_IMAGE_SEEKDIALOG     RC_NULL
#define RC_IMAGE_LOGINDIALOG    RC_NULL
#define RC_IMAGE_LIVEDIALOG     RC_NULL
#define RC_IMAGE_SYNCDIALOG     RC_NULL

#define RC_IMAGE_PICKDIALOG     RC_NULL
#define RC_IMAGE_WINDOWPICKDIALOG       RC_NULL
#define RC_IMAGE_PROCESSPICKDIALOG      RC_NULL

#define RC_IMAGE_OPENCONTEXTMENU RC_NULL
#define RC_IMAGE_OPENFILE       RC_NULL
#define RC_IMAGE_OPENURL        RC_NULL
#define RC_IMAGE_OPENANNOTATIONURL RC_NULL
#define RC_IMAGE_OPENDEVICE     RC_IMAGE_OPEN
#define RC_IMAGE_OPENVIDEODEVICE RC_NULL
#define RC_IMAGE_OPENAUDIODEVICE RC_NULL
#define RC_IMAGE_OPENSUBTITLE   RC_NULL

#define RC_IMAGE_ADVANCED       RC_NULL
#define RC_IMAGE_CLEARCACHE     RC_NULL

#define RC_IMAGE_CONNECT        RC_NULL
#define RC_IMAGE_DISCONNECT     RC_NULL

#define RC_IMAGE_WINDOWSTAYSONTOP RC_NULL
#define RC_IMAGE_EMBEDONTOP     RC_NULL

#define RC_IMAGE_ANNOTATIONBROWSER RC_NULL
#define RC_IMAGE_ANNOTATIONEDITOR RC_NULL
#define RC_IMAGE_TOKENVIEW      RC_NULL
#define RC_IMAGE_COMMENTVIEW    RC_NULL
#define RC_IMAGE_PROXYVIEW      RC_NULL
#define RC_IMAGE_SIGNALVIEW     RC_NULL
#define RC_IMAGE_SITEACCOUNT    RC_NULL
#define RC_IMAGE_MEDIAINFO      RC_NULL

#define RC_IMAGE_EDIT           RC_NULL
#define RC_IMAGE_HIDE           RC_NULL
#define RC_IMAGE_SHOW           RC_NULL
#define RC_IMAGE_BLOCK          RC_NULL
#define RC_IMAGE_BLESS          RC_NULL
#define RC_IMAGE_CURSE          RC_NULL
#define RC_IMAGE_VIEW           RC_NULL
#define RC_IMAGE_DELETE         RC_NULL
#define RC_IMAGE_DELETECACHE    RC_NULL
...
#define RC_IMAGE_REFRESH        RC_NULL
#define RC_IMAGE_REFRESHPROCESS RC_IMAGE_REFRESH
#define RC_IMAGE_ATTACHPROCESS  RC_NULL
#define RC_IMAGE_DETACHPROCESS  RC_NULL

#define RC_IMAGE_RECENTMESSAGES RC_NULL

#define RC_IMAGE_TRANSLATE      RC_NULL

#define RC_IMAGE_ANNOTATIONLIMIT RC_NULL

#define RC_IMAGE_OPENINWEBBROWSER RC_NULL
#define RC_IMAGE_DOWNLOADCURRENT RC_NULL
#define RC_IMAGE_COPYCURRENTURL RC_NULL
#define RC_IMAGE_COPYCURRENTTITLE RC_NULL

#define RC_IMAGE_NETWORKPROXY   RC_NULL

#define RC_IMAGE_CLEAR          RC_NULL
#define RC_IMAGE_HISTORY        RC_NULL

#define RC_IMAGE_RECENT         RC_NULL
#define RC_IMAGE_RECENTFILE     RC_NULL
...
#define RC_IMAGE_RUSSIAN        ACRC_IMAGE_RUSSIAN
#define RC_IMAGE_UKNOWN         RC_NULL
//#define RC_IMAGE_UNKNOWNLANGUAGE RC_NULL
#define RC_IMAGE_ANYLANGUAGE    RC_NULL
#define RC_IMAGE_TRADITIONALCHINESE ACRC_IMAGE_ROC
#define RC_IMAGE_SIMPLIFIEDCHINESE  ACRC_IMAGE_PRC

#define RC_IMAGE_ANONYMOUS  RC_NULL
#define RC_IMAGE_CHECKINTERNET  RC_NULL

#define RC_IMAGE_SUBTITLEONTOP  RC_NULL
#define RC_IMAGE_MONITORCLIPBOARD RC_NULL

#define RC_IMAGE_DEFAULTCOLOR   RC_NULL
#define RC_IMAGE_REDCOLOR       RC_NULL
#define RC_IMAGE_WHITECOLOR     RC_NULL
#define RC_IMAGE_CYANCOLOR      RC_NULL
#define RC_IMAGE_BLUECOLOR      RC_NULL
#define RC_IMAGE_PURPLECOLOR    RC_NULL
#define RC_IMAGE_ORANGECOLOR    RC_NULL
#define RC_IMAGE_BLACKCOLOR     RC_NULL

#define RC_IMAGE_DEFAULTTHEME   ACRC_IMAGE_AERO_PREVIEW
#define RC_IMAGE_RANDOMTHEME    ACRC_NULL
...
#define RC_IMAGE_AUTO           RC_NULL
#define RC_IMAGE_DEFAULT        RC_NULL
#define RC_IMAGE_TRANSPARENT    RC_NULL
#define RC_IMAGE_SHADOW         RC_NULL
#define RC_IMAGE_BLUR           RC_NULL

#define RC_IMAGE_HOMEPAGE       RC_NULL

#define RC_IMAGE_NOTHINGAFTERFINISHED RC_NULL
#define RC_IMAGE_SLEEPAFTERFINISHED RC_NULL
#define RC_IMAGE_SHUTDOWNAFTERFINISHED RC_NULL

#define RC_IMAGE_MULTIWINDOW    RC_NULL
#define RC_IMAGE_NEWWINDOW      RC_NULL

#define RC_IMAGE_ASPECTRATIOSTANDARD    RC_NULL
#define RC_IMAGE_ASPECTRATIOWIDESCREEN  RC_NULL

#define RC_IMAGE_ANNOTANALYTICS  RC_NULL
#define RC_IMAGE_AUTOSUBMIT   RC_NULL
#define RC_IMAGE_AUTOSAVEMEDIA RC_NULL
#define RC_IMAGE_SAVEMEDIA    RC_NULL

#define RC_IMAGE_MORE    RC_NULL
#define RC_IMAGE_LESS    RC_NULL

#define RC_IMAGE_RESUMEANNOT  RC_NULL
#define RC_IMAGE_RESETANNOTROTATION  RC_NULL
#define RC_IMAGE_INCREASEANNOTROTATION  RC_NULL
#define RC_IMAGE_DECREASEANNOTROTATION  RC_NULL
#define RC_IMAGE_RESETANNOTSCALE  RC_NULL
#define RC_IMAGE_INCREASEANNOTSCALE  RC_NULL
#define RC_IMAGE_DECREASEANNOTSCALE  RC_NULL
#define RC_IMAGE_RESETANNOTOFFSET  RC_NULL
#define RC_IMAGE_INCREASEANNOTOFFSET  RC_NULL
#define RC_IMAGE_DECREASEANNOTOFFSET  RC_NULL

#define RC_IMAGE_RESET  RC_NULL

#define RC_IMAGE_HUEUP  RC_NULL
#define RC_IMAGE_HUEDOWN  RC_NULL
#define RC_IMAGE_SATURATIONUP  RC_NULL
#define RC_IMAGE_SATURATIONDOWN  RC_NULL
#define RC_IMAGE_GAMMAUP  RC_NULL
#define RC_IMAGE_GAMMADOWN  RC_NULL
#define RC_IMAGE_BRIGHTNESSUP  RC_NULL
#define RC_IMAGE_BRIGHTNESSDOWN  RC_NULL
#define RC_IMAGE_CONTRASTUP  RC_NULL
#define RC_IMAGE_CONTRASTDOWN  RC_NULL

#define RC_IMAGE_LABELPLAYER  RC_NULL
#define RC_IMAGE_OPENDIRECTORY  RC_NULL
#define RC_IMAGE_PREFERLOCALDB  RC_NULL

#define RC_IMAGE_NOAUTOPLAY  RC_NULL
#define RC_IMAGE_AUTOPLAYNEXT  RC_NULL
#define RC_IMAGE_AUTOPLAYCURRENT  RC_NULL

#define RC_IMAGE_PREFERENCES  RC_NULL
