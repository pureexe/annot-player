...
QComboBox*
AcUi::makeComboBox(ulong hints, const QString &text, const QString &tip, const QStringList &items)
{
  QComboBox *ret;
  if (hints | EditHint)
...
QLineEdit*
AcUi::makeLineEdit(ulong hints, const QString &text, const QString &tip)
{
