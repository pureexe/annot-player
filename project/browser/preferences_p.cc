...
HTML_TABLE_OPEN()
  ...
  HTML_TR(HTML_TD(+tr("Previous in History")+) HTML_TD(S_Right))
  HTML_TR(HTML_TD(+tr("Next in History")+)     HTML_TD(S_Left))
  HTML_TR(HTML_TD(+tr("Previous Tab")+)        HTML_TD(S_Up " " S_Right))
  HTML_TR(HTML_TD(+tr("Next Tab")+)            HTML_TD(S_Up " " S_Left))
